...
See `COPYING` for the full license text, or visit https://www.gnu.org/licenses/
 ...
 The files that are not under the GPL v3.0 are clearly marked with what license they are under within their headers
...
**pywinstyles - CC0 1.0 Universal**
https://github.com/Akascape/py-window-styles
**This work has been dedicated to the public domain under CC0 1.0 Universal.**

___

**CTkMenuBarPlus - MIT License**
https://github.com/KiTant/CTkMenuBarPlus
**Copyright (c) 2025-2026 xzyqox**
